...
class CreateTableNoticesGarden extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('notices_gardens')) {
            Schema::create('notices_gardens', function (Blueprint $table) {
                $table->increments('id');
    ...
    {
        Schema::dropIfExists('notices_gardens');
    }
}
