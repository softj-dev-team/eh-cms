    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body with-padding">
              ...
              <div class="form-group">
                <input class="form-control" name="start_date" id="start_date" placeholder="시작일" type="datetime-local">
              </div>
              <div class="form-group">
                <input class="form-control" name="end_date" id="end_date" placeholder="종료일" type="datetime-local">
              </div>
              <div class="form-group">
                <input class="form-control" name="url" id="url_slide" placeholder="Link" type="text">
              </div>
            </div>
    ...
    $(document).ready(function () {
        ...
        list_photo_gallery.on('click', '.photo-gallery-item', function () {
            ...
            if (images != null && typeof images[id] != 'undefined') {
                ...
                $('#start_date').val(images[id].start_date);
                $('#end_date').val(images[id].end_date);
                $('#url_slide').val(images[id].url);
            }
        ...
        edit_gallery_modal.on('click', '#update-gallery-item', function (event) {
            ...
            if (images != null && typeof images[id] != 'undefined') {
                ...
                images[id].start_date = $('#start_date').val();
                images[id].end_date = $('#end_date').val();
                images[id].url = $('#url_slide').val();
            }
            result.val(JSON.stringify(images));
