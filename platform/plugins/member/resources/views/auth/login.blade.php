          ...
          <div class="card-body">
            <form method="POST" action="{{ route('public.member.login') }}">
              ...
              <div class="form-group row">
                <label for="id_login" class="col-sm-4 col-form-label text-md-right">{{ trans('plugins/member::dashboard.id_login') }}</label>
                <div class="col-md-6">
                  <input id="id_login" type="text" class="form-control{{ $errors->has('id_login') ? ' is-invalid' : '' }}" name="id_login" value="{{ old('id_login') }}" autofocus>
