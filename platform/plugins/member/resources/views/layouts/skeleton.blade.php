...
<!-- Datetime picker -->
  ...
  <link rel="stylesheet" href="/vendor/core/packages/font-awesome/css/fontawesome.min.css"/>
...
<!-- Styles -->
  ...
  <link href="{{ asset('vendor/core/plugins/member/css/headerMember.css') }}" rel="stylesheet">
...
{{-- @include('plugins.member::modals.garden') --}}
</body>
</html>
