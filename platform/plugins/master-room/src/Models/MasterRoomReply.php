 ...
 * @mixin \Eloquent
 */
class MasterRoomReply extends Eloquent
{
    use EnumCastable;
     ...
     * @var string
     */
    protected $table = 'master_room_replies';
    ...
    {
        return $this->hasMany(CommentsMasterRoomReply::class, 'master_room_reply_id')->orderBy('created_at', 'DESC');
    }
