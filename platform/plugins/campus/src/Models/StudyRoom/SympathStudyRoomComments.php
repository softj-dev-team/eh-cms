 ...
 * @mixin \Eloquent
 */
class SympathStudyRoomComments extends Eloquent
{
    use EnumCastable;
     ...
     * @var string
     */
    protected $table = 'sympathy_study_room_comments';
     ...
     * @var string
     */
    protected $screen = SYMPATHY_STUDY_ROOM_COMMENTS;
    ...
    {
        return $this->belongsTo(StudyRoomComments::class, 'comments_id')->orderBy('created_at', 'DESC');
    }
}
