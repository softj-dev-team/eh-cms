    ...
    <div class="top-menu">
        <ul class="nav navbar-nav float-right collapse">
            ...
            {{-- <li class="language dropdown">
                <a href="javascript:;" class="dropdown-toggle dropdown-header-name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    @if (app()->getLocale() == "ko")
                        {!! language_flag('kr', '한국어') !!} 
                        <span class="d-none d-sm-inline">한국어</span>
                    @else
                    {!! language_flag('us', 'English') !!}
                ...
                <ul class="dropdown-menu dropdown-menu-right icons-right">
                        <li @if(app()->getLocale() == "en") class="active"  @endif >
                            <a href="{{ route('admin.language', 'en') }}">
                                {!! language_flag('us', 'English') !!} <span>English</span>
                            </a>
                        </li>
                    
                        <li @if(app()->getLocale() == "ko") class="active"  @endif>
                            <a href="{{ route('admin.language', 'ko') }}">
                                {!! language_flag('kr', '한국어') !!} <span>한국어</span>
                            </a>
                        </li>
                </ul>
            </li> --}}
