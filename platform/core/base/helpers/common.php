...
if (!function_exists('get_word_rejects')) {
    /**
     * @return array
     * @author Sang Nguyen
     */
    function get_word_rejects()
    {
        $list = json_decode(setting('word_rejects', '[]'), true);
...
if (!function_exists('set_cookie_response')){
    /**
     * @return void
     * @author Sang Nguyen
     */
    function set_cookie_response($data, $time = 300)
    {
        Cookie::queue('password_garden', $data, $time);
    }
}
