        ...
        <div class="sidebar-template__content">
          ...
          <div class="event-details single">
            ...
            <div class="row no-gutters justify-content-between">
              @if($idCategory != '81' && $idCategory != '83')
{{--              <div class="col-md-6">--}}
...
{{--                  <span class="item__datetime__detail">{{Carbon\Carbon::parse( $masterRoom->start)->format('Y-m-d')}} -  {{ Carbon\Carbon::parse( $masterRoom->end)->format('Y-m-d')}}</span>--}}
{{--                </p>--}}
{{--              </div>--}}
              @endif
{{--              <div class="col-md-6">--}}
