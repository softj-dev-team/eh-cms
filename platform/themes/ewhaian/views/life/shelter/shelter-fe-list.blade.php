    ...
    <div class="container">
        <div class="sidebar-template">
            <div class="sidebar-template__control">
                ...
                <div class="sidebar-template__control">
                        <div class="nav nav-left">
                          <ul class="nav__list">
                            <p class="nav__title">{{__('life.shelter_info')}}</p>
                            <li class="nav__item">
                              <a  class="active" href="javascript:{}" title="{{__('life.shelter_info.shelter_info_list')}}">{{__('life.shelter_info.shelter_info_list')}}</a>
                            </li>
                            <li class="nav__item">
                              <a href="{{route('shelterFE.create')}}" title="{{__('life.shelter_info.create_shelter')}}">{{__('life.shelter_info.create_shelter')}}</a>
                            </li>
                          </ul>
                        </div>
                      </div>
            ...
            <div class="sidebar-template__content">
                ...
                <h3 class="title-main">{{__('life.shelter_info.shelter_info_list')}}</h3>
                @if (session('success'))
                ...
                <div class="event-list">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="item__image">
                                    ...
                                    @endif
                                    <a href="{{route('shelterFE.edit',['id'=>$item->id])}}" title="{{ strip_tags($item->title) }}">
                                ...
                                <div class="item__caption">
                                    <h4 class="item__title">
                                        <a href="{{route('shelterFE.edit',['id'=>$item->id])}}"
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item__desc">
                                <br>
                                <h3>{{__('life.shelter_info.no_have_shelter')}}</h3>
                            </div>
                        </div>
                        @endif
                    </div>

                    {!! Theme::partial('paging',['paging'=>$shelter ]) !!}
         ...
         <div class="d-lg-flex align-items-start flex-grow-1">
           <div class="form-group form-group--1 flex-grow-1 mr-lg-30 mb-3">
             <label for="hint" class="form-control">
               <input type=" text" id="hint" value="{{__('life.shelter_info.confirm_delete')}}" placeholder="&nbsp;" readonly>
             </label>
           </div>
         </div>
         <form action="{{route('shelterFE.delete')}}" method="post">
           @csrf
           <div class="button-group mb-2">
               <input type="hidden" value="0" id="room_id" name="id">
               <button type="button" class="btn btn-outline mr-lg-10" data-dismiss="modal">{{__('life.shelter_info.cancel')}}</button>
               <button type="submit" class="btn btn-primary">{{__('life.shelter_info.delete')}}</button>
           </div>
       </form>
       </div>
     </div>
