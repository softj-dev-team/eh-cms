    ...
    <div class="container">
        <div class="sidebar-template">
            <div class="sidebar-template__control">
               <!-- flea FE menu -->
               {!! Theme::partial('life.menuFE',['categories'=>$categories]) !!}
            ...
            <div class="sidebar-template__content">
                ...
                <h3 class="title-main">{{__('life.flea_market.flea_market_list')}}</h3>
                @if (session('success'))
                ...
                <div class="event-list">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="item__image">
                                    ...
                                    @endif
                                    <a href="{{route('flareMarketFE.edit',['id'=>$item->id])}}" title="{{ strip_tags($item->title) }}">
                                    ...
                                    <div class="item__info">
                                        <div class="item__date">
                                            ...
                                            <?php
                                                ...
                                                $end = date("Y-m-d",strtotime( $item->created_at) );
                                ...
                                <div class="item__caption">
                                    <h4 class="item__title">
                                        <a href="{{route('flareMarketFE.edit',['id'=>$item->id])}}"
                                    ...
                                    <div class="item__datetime">
                                        ...
                                        <span class="item__datetime__detail">{{date('d M | H:i a', strtotime($start))}}
                                            - {{ date('d M | h:i a', strtotime($end))}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item__desc">
                                <br>
                                <h3>{{__('life.flea_market.no_flea_market')}}</h3>
                            </div>
                        </div>
                        @endif
                    </div>

                    {!! Theme::partial('paging',['paging'=>$flare ]) !!}
        ...
        <div class="d-lg-flex align-items-start flex-grow-1">
          <div class="form-group form-group--1 flex-grow-1 mr-lg-30 mb-3">
            <label for="hint" class="form-control">
              <input type=" text" id="hint" value="{{__('life.flea_market.confirm_delete')}}" placeholder="&nbsp;" readonly>
            </label>
          </div>
        </div>
        <form action="{{route('flareMarketFE.delete')}}" method="post">
          @csrf
          <div class="button-group mb-2">
              <input type="hidden" value="0" id="room_id" name="id">
              <button type="button" class="btn btn-outline mr-lg-10" data-dismiss="modal">{{__('life.flea_market.cancel')}}</button>
              <button type="submit" class="btn btn-primary">{{__('life.flea_market.delete')}}</button>
          </div>
      </form>
      </div>
    </div>
