    ...
    <div class="container">
        <div class="sidebar-template">
            <div class="sidebar-template__control">
                ...
                <div class="sidebar-template__control">
                        <div class="nav nav-left">
                          <ul class="nav__list">
                            <p class="nav__title">{{__('life.advertisements')}}</p>
                            <li class="nav__item">
                              <a  class="active" href="javascript:{}" title="{{__('life.advertisements.advertisements_list')}}">{{__('life.advertisements.advertisements_list')}}</a>
                            </li>
                            <li class="nav__item">
                              <a href="{{route('adsFE.create')}}" title="{{__('life.advertisements.create_advertisements')}}">{{__('life.advertisements.create_advertisements')}}</a>
                            </li>
                          </ul>
                        </div>
                      </div>
            ...
            <div class="sidebar-template__content">
                ...
                <h3 class="title-main">{{__('life.advertisements.advertisements_list')}}</h3>
                @if (session('success'))
                ...
                <div class="event-list">
                    <div class="row">
                            ...
                            <div class="item">
                                <div class="item__image">
                                    <div class="item__image mb-10">
                                        ...
                                        @endif
                                        <a href="{{route('adsFE.edit',['id'=>$item->id])}}" title="{{ strip_tags($item->title) }}">
                                    ...
                                    <div class="item__info">
                                        <div class="item__date">
                                            ...
                                            {{ getDeadlineDate( $item->deadline,2) }}
                                        </div>
                                        <div class="item__eye">
                                ...
                                <div class="item__caption">
                                    <h4 class="item__title">
                                        <a href="{{route('adsFE.edit',['id'=>$item->id])}}"
                                    ...
                                    <div class="item__datetime">
                                        ...
                                        <span class="item__datetime__detail"> {{ getDeadlineDate( $item->deadline,2) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item__desc">
                                <br>
                                <h3>{{__('life.advertisements.no_advertisements')}}</h3>
                            </div>
                        </div>
                        @endif
                    </div>

                    {!! Theme::partial('paging',['paging'=>$ads ]) !!}
        ...
        <div class="d-lg-flex align-items-start flex-grow-1">
          <div class="form-group form-group--1 flex-grow-1 mr-lg-30 mb-3">
            <label for="hint" class="form-control">
              <input type=" text" id="hint" value="{{__('life.advertisements.confirm_delete')}}" placeholder="&nbsp;" readonly>
            </label>
          </div>
        </div>
        <form action="{{route('adsFE.delete')}}" method="post">
          @csrf
          <div class="button-group mb-2">
              <input type="hidden" value="0" id="room_id" name="id">
              <button type="button" class="btn btn-outline mr-lg-10" data-dismiss="modal">{{__('life.advertisements.cancel')}}</button>
              <button type="submit" class="btn btn-primary">{{__('life.advertisements.delete')}}</button>
          </div>
      </form>
      </div>
    </div>
