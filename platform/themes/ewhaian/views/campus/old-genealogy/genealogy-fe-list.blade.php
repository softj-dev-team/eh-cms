    ...
    <div class="container">
        <div class="sidebar-template">
                ...
                <div class="sidebar-template__control">
                        <div class="nav nav-left">
                          <ul class="nav__list">
                            ...
                            <li class="nav__item">
                              <a  class="active" href="javascript:{}" title="{{__('campus.old_genealogy.genealogy_list')}}">{{__('campus.old_genealogy.genealogy_list')}}</a>
                            </li>
                            <li class="nav__item">
                              <a href="{{route('oldGenealogyFE.create')}}" title="{{__('campus.old_genealogy.create_old_genealogy')}}">{{__('campus.old_genealogy.create_old_genealogy')}}</a>
                            </li>
                          </ul>
                        </div>
                      </div>
            ...
            <div class="sidebar-template__content">
                ...
                <h3 class="title-main">{{__('campus.old_genealogy.genealogy_list')}}</h3>
                @if (session('success'))
                ...
                <div class="event-list">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="item__image">
                                    ...
                                    @endif
                                    <a href="{{route('oldGenealogyFE.edit',['id'=>$item->id])}}" title="{{ strip_tags($item->title) }}">
                                        <div style="background: url('{{ geFirsttImageInArray($item->images, 'event-thumb')  }}') no-repeat center; background-size:contain; height: 180px;">
                                        </div>
                                    </a>
                                        <a  href="javascript:void(0)" class="btn_remove_image deleteRoom" title="{{__('campus.old_genealogy.remove_image')}}" data-toggle="modal" data-value="{{$item->id}}" data-target="#confirmDelete" >
                                ...
                                <div class="item__caption">
                                    <h4 class="item__title">
                                        <a href="{{route('oldGenealogyFE.edit',['id'=>$item->id])}}"
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item__desc">
                                <br>
                                <h3>{{__('campus.old_genealogy.no_genealogy')}}</h3>
                            </div>
                        </div>
                        @endif
                    </div>

                    {!! Theme::partial('paging',['paging'=>$oldGenealogy ]) !!}
         ...
         <div class="d-lg-flex align-items-start flex-grow-1">
           <div class="form-group form-group--1 flex-grow-1 mr-lg-30 mb-3">
             <label for="hint" class="form-control">
               <input type=" text" id="hint" value="{{__('campus.old_genealogy.confirm_delete')}}" placeholder="&nbsp;" readonly>
             </label>
           </div>
         </div>
         <form action="{{route('oldGenealogyFE.delete')}}" method="post">
           @csrf
           <div class="button-group mb-2">
               <input type="hidden" value="0" id="room_id" name="id">
               <button type="button" class="btn btn-outline mr-lg-10" data-dismiss="modal">{{__('campus.old_genealogy.cancel')}}</button>
               <button type="submit" class="btn btn-primary">{{__('campus.old_genealogy.delete')}}</button>
           </div>
       </form>
       </div>
     </div>
