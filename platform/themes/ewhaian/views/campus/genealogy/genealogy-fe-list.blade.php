    ...
    <div class="container">
        <div class="sidebar-template">
                ...
                <div class="sidebar-template__control">
                        <div class="nav nav-left">
                          <ul class="nav__list">
                            ...
                            <li class="nav__item">
                              <a  class="active" href="javascript:{}" title="{{__('campus.genealogy.genealogy_list')}}">{{__('campus.genealogy.genealogy_list')}}</a>
                            </li>
                            <li class="nav__item">
                              <a href="{{route('genealogyFE.create')}}" title="{{__('campus.genealogy.create_genealogy')}}">{{__('campus.genealogy.create_genealogy')}}</a>
                            </li>
                          </ul>
                        </div>
                      </div>
            ...
            <div class="sidebar-template__content">
                ...
                <h3 class="title-main">{{__('campus.genealogy.genealogy_list')}}</h3>
                @if (session('success'))
                ...
                <div class="event-list">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="item__image">
                                    ...
                                    @endif
                                    <a href="{{route('genealogyFE.edit',['id'=>$item->id])}}" title="{{ strip_tags($item->title) }}">
                                        ...
                                        <a  href="javascript:void(0)" class="btn_remove_image deleteRoom" title="{{__('campus.genealogy.remove_room')}}" data-toggle="modal" data-value="{{$item->id}}" data-target="#confirmDelete" >
                                ...
                                <div class="item__caption">
                                    <h4 class="item__title">
                                        <a href="{{route('genealogyFE.edit',['id'=>$item->id])}}"
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item__desc">
                                <br>
                                <h3>{{__('campus.genealogy.no_genealogy')}}</h3>
                            </div>
                        </div>
                        @endif
                    </div>

                    {!! Theme::partial('paging',['paging'=>$genealogy ]) !!}
         ...
         <div class="d-lg-flex align-items-start flex-grow-1">
           <div class="form-group form-group--1 flex-grow-1 mr-lg-30 mb-3">
             <label for="hint" class="form-control">
               <input type=" text" id="hint" value="Do you really want to delete this room?" placeholder="&nbsp;" readonly>
             </label>
           </div>
         </div>
         <form action="{{route('genealogyFE.delete')}}" method="post">
           @csrf
