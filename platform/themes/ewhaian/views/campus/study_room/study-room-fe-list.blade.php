    ...
    <div class="container">
        <div class="sidebar-template">
                ...
                <div class="sidebar-template__control">
                        <div class="nav nav-left">
                          <ul class="nav__list">
                            ...
                            <li class="nav__item">
                              <a  class="active" href="javascript:{}" title="{{__('campus.study_room.study_room_list')}}">{{__('campus.study_room.study_room_list')}}</a>
                            </li>
                            <li class="nav__item">
                              <a href="{{route('studyRoomFE.create')}}" title="{{__('campus.study_room.create_study_room')}}">{{__('campus.study_room.create_study_room')}}</a>
                            </li>
                          </ul>
                        </div>
                      </div>
            ...
            <div class="sidebar-template__content">
                ...
                <h3 class="title-main">{{__('campus.study_room.study_room_list')}}</h3>
                @if (session('success'))
                ...
                <div class="event-list">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item">
                                <div class="item__image">
                                    ...
                                    @endif
                                    <a href="{{route('studyRoomFE.edit',['id'=>$item->id])}}" title="{{ strip_tags($item->title) }}">
                                ...
                                <div class="item__caption">
                                    <h4 class="item__title">
                                        <a href="{{route('studyRoomFE.edit',['id'=>$item->id])}}"
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="item__desc">
                                <br>
                                <h3>{{__('campus.study_room.no_study_room')}}</h3>
                            </div>
                        </div>
                        @endif
                    </div>

                    {!! Theme::partial('paging',['paging'=>$studyRoom ]) !!}
        ...
        <div class="d-lg-flex align-items-start flex-grow-1">
          <div class="form-group form-group--1 flex-grow-1 mr-lg-30 mb-3">
            <label for="hint" class="form-control">
              <input type=" text" id="hint" value="{{__('campus.study_room.confirm_delete')}}" placeholder="&nbsp;" readonly>
            </label>
          </div>
        </div>
        <form action="{{route('studyRoomFE.delete')}}" method="post">
          @csrf
          <div class="button-group mb-2">
              <input type="hidden" value="0" id="room_id" name="id">
              <button type="button" class="btn btn-outline mr-lg-10" data-dismiss="modal">{{__('campus.study_room.cancel')}}</button>
              <button type="submit" class="btn btn-primary">{{__('campus.study_room.delete')}}</button>
          </div>
      </form>
      </div>
    </div>
