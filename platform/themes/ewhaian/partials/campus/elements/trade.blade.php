<div class=" d-sm-flex flex-wrap custom-checkbox form-group pt-2 align-items-center" style="margin-bottom: 0px;">
        <div class="d-sm-flex flex-wrap flex-grow-1 align-items-center">
            <div class="custom-control mr-4">
                ...
                <label class="custom-control-label" for="directDeal">Direct deals</label>
            </div>
            <div class="custom-control custom-checkbox mx-3 mr-4">
                <input type="checkbox" class="custom-control-input" checked id="delivery" @if(isset($exchange[2]) && $exchange[2] == 2) checked @endif disabled="disabled" >
            ...
            <div class="custom-control custom-checkbox mx-3 mr-4">
                ...
                <label class="custom-control-label" for="locker">Locker</label>
            </div>
            <div class="custom-control custom-checkbox mx-3 mr-4">
            ...
            <input type="text" class="form-control form-control--auto flex-grow-1" placeholder="Enter your words" value="{{$exchange[5] ?? "No Exchange"}}" @if( !isset($exchange[4])  || $exchange[4] != 4) hidden @endif readonly>
        </div>
    </div>
