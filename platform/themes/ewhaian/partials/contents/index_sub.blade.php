                ...
                <div class=" table-responsive">
                        <table class="table table--content-middle">
                            <thead>
                                ...
                                <th style="text-align: center;width:15%;">{{__('contents.lookup')}}
                                </th>
                            </thead>
                            <tbody>
                                @if(count($contents) > 0 )
                ...
                @default
                    <div class=" table-responsive">
                        <table class="table table--content-middle"style="width:100%;">
                            <thead>
                                <th class="d-none d-lg-table-cell" style="text-align: center;max-width:148px;min-width:100px"> {{__('contents.banner')}}</th>
                            ...
                            @if(count($contents))
                                ...
                                <tr >
                                    <td class="d-none d-lg-table-cell">
                                     ...
                                     <td class="d-none d-lg-table-cell" style="text-align: center;">{{getStatusDateByDate($item->published)}}</td>
